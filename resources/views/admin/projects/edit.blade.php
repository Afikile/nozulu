                ...
                <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="category">
                            Category * <span class="text-gray-600 font-normal">(Select which gallery this project belongs to)</span>
                        </label>
                        <select name="category" id="category" required
                            ...
                            <option value="electrical" {{ old('category', $project->category) == 'electrical' ? 'selected' : '' }}>⚡ Electrical Works Gallery</option>
                            <option value="construction" {{ old('category', $project->category) == 'construction' ? 'selected' : '' }}>🏗️ Construction Works Gallery</option>
                        </select>
                        <p class="text-gray-600 text-xs mt-1">Moving this project to a different gallery will change which dropdown menu it appears under.</p>
                        @error('category')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="duration" id="duration" value="{{ old('duration', $project->duration) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="client" id="client" value="{{ old('client', $project->client) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="consultant" id="consultant" value="{{ old('consultant', $project->consultant) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="cost" id="cost" value="{{ old('cost', $project->cost) }}" required
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            @for($i = 1; $i <= 4; $i++)
                                <div>
                                    ...
                                    @if($project->{"image{$i}"})
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $project->{"image{$i}"}) }}" alt="Current image" class="w-32 h-32 object-cover rounded">
